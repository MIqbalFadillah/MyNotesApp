...
import static com.blogspot.labalabamen.iqbal.mynotesapp.db.DatabaseContract.NoteColumns.DATE;
import static com.blogspot.labalabamen.iqbal.mynotesapp.db.DatabaseContract.NoteColumns.DESCRIPTION;
import static com.blogspot.labalabamen.iqbal.mynotesapp.db.DatabaseContract.NoteColumns.TITLE;
import static com.blogspot.labalabamen.iqbal.mynotesapp.db.DatabaseContract.TABLE_NOTE;
...
public class NoteHelper {
    ...
    public long insert(Note note){
        ...
        intialValues.put(TITLE, note.getTitle());
        intialValues.put(DESCRIPTION, note.getDescription());
        intialValues.put(DATE, note.getDate());
